...
<div class="container" style="padding: 36px 18px 80px; max-width: 1200px;">
    ...
    <!-- Official Contacts Cards Grid (3 Kotak Sejajar Responsif) -->
    <div class="contact-cards-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-bottom: 36px;">
        <!-- WhatsApp Card -->
        <div class="contact-card" style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 18px; padding: 26px 22px; display: flex; flex-direction: column; transition: transform 0.2s ease; box-shadow: 0 4px 16px rgba(0,0,0,0.25);">
            <div style="width: 44px; height: 44px; border-radius: 10px; background: rgba(34, 197, 94, 0.14); color: #22c55e; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; border: 1px solid rgba(34, 197, 94, 0.3);">
            ...
            <p style="color: var(--text-muted); font-size: 0.84rem; line-height: 1.5; margin-bottom: 14px;">
                Fast response 24/7 untuk pembelian langsung, tanya spesifikasi & klaim garansi.
            </p>
            <div style="font-size: 0.82rem; font-weight: 700; color: #22c55e; margin-bottom: 18px; display: flex; align-items: center; gap: 6px;">
                <span style="width: 7px; height: 7px; border-radius: 50%; background: #22c55e; display: inline-block;"></span>
                <span>Customer Care 24/7 Terverifikasi</span>
            </div>
            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', \App\Models\SiteSetting::get('whatsapp_number', '6282324634848')) }}" target="_blank" class="btn" style="margin-top: auto; width: 100%; background: #16a34a; color: #fff; font-weight: 800; padding: 10px; border-radius: 10px; box-shadow: 0 2px 8px rgba(22,163,74,0.3);">
        ...
        <!-- Discord Card -->
        <div class="contact-card" style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 18px; padding: 26px 22px; display: flex; flex-direction: column; transition: transform 0.2s ease; box-shadow: 0 4px 16px rgba(0,0,0,0.25);">
            <div style="width: 44px; height: 44px; border-radius: 10px; background: rgba(99, 102, 241, 0.14); color: #818cf8; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; border: 1px solid rgba(99, 102, 241, 0.3);">
            ...
            <div style="font-size: 0.82rem; font-weight: 700; color: #818cf8; margin-bottom: 18px; display: flex; align-items: center; gap: 6px;">
            ...
            <a href="{{ $discordUrl }}" target="_blank" class="btn" style="margin-top: auto; width: 100%; background: #4f46e5; color: #fff; font-weight: 800; padding: 10px; border-radius: 10px; box-shadow: 0 2px 8px rgba(79,70,229,0.3);">
        ...
        <!-- Instagram Card -->
        <div class="contact-card" style="background: var(--bg-card); border: 1px solid var(--border); border-radius: 18px; padding: 26px 22px; display: flex; flex-direction: column; transition: transform 0.2s ease; box-shadow: 0 4px 16px rgba(0,0,0,0.25);">
            <div style="width: 44px; height: 44px; border-radius: 10px; background: rgba(225, 29, 72, 0.14); color: #fb7185; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; border: 1px solid rgba(225, 29, 72, 0.3);">
            ...
            <div style="font-size: 0.82rem; font-weight: 700; color: #fb7185; margin-bottom: 18px; display: flex; align-items: center; gap: 6px;">
                <span style="width: 7px; height: 7px; border-radius: 50%; background: #fb7185; display: inline-block;"></span>
                <span>Official Social Media Account</span>
            </div>
            <a href="https://instagram.com/{{ $igUsername }}" target="_blank" class="btn" style="margin-top: auto; width: 100%; background: #e11d48; color: #fff; font-weight: 800; padding: 10px; border-radius: 10px; box-shadow: 0 2px 8px rgba(225,29,72,0.3);">
