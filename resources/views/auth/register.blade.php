...
<div style="min-height: calc(100vh - 320px); display: flex; align-items: center; justify-content: center; padding: 48px 18px 80px;">
    <div style="width: 100%; max-width: 460px; background: var(--bg-card, #0e1628); border: 1px solid var(--border-light, rgba(255,255,255,0.1)); border-radius: 22px; padding: 36px 30px; box-shadow: 0 20px 50px rgba(0,0,0,0.7), 0 0 35px rgba(0, 242, 254, 0.08); position: relative; overflow: hidden;">
        ...
        <div style="text-align: center; margin-bottom: 26px;">
            ...
            <h1 class="font-heading" style="font-size: 1.55rem; font-weight: 900; color: #fff; margin: 0 0 6px;">Daftar Akun Baru</h1>
            <p style="font-size: 0.86rem; color: var(--text-muted, #94a3b8); margin: 0; line-height: 1.45;">Bergabunglah dengan ribuan gamer di platform ALZIS STORE.</p>
        </div>
