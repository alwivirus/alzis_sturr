...
<div class="auth-page-wrapper" style="min-height: calc(100vh - 240px); display: flex; align-items: center; justify-content: center; padding: 40px 16px; width: 100%; box-sizing: border-box;">
    <div class="auth-card auth-card-wide" style="width: 100%; max-width: 480px; margin: 0 auto; background: var(--bg-card); border: 1px solid var(--border-light); border-radius: 20px; padding: 32px 24px; box-shadow: 0 15px 40px rgba(0,0,0,0.5); position: relative; overflow: hidden; box-sizing: border-box;">
            ...
            <div class="auth-grid-2" style="margin-bottom: 20px;">
                <div>
                    ...
                    <input type="password" id="password" name="password" required placeholder="Min 6 karakter" 
                           style="width: 100%; background: var(--bg-surface, #101726); border: 1px solid var(--border-light, rgba(255,255,255,0.12)); border-radius: 12px; color: #fff; padding: 12px 14px; font-size: 0.88rem; outline: none; transition: border-color 0.2s ease;">
                    @error('password')
        ...
        <div style="text-align: center; margin-top: 20px; font-size: 0.84rem; color: var(--text-muted, #94a3b8);">
            Sudah punya akun? 
            <a href="{{ route('login') }}" style="color: var(--primary, #3b82f6); font-weight: 800; text-decoration: none;">Masuk di Sini</a>
        </div>
    </div>
</div>
@endsection
