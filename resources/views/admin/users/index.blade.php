    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(175px, 1fr)); gap: 16px;">
        ...
        <div class="stat-card" style="border-left: 3px solid var(--primary);">
            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                ...
                <div style="width: 34px; height: 34px; border-radius: 8px; background: rgba(0, 242, 254, 0.12); color: var(--primary); display: flex; align-items: center; justify-content: center;">
...
<div id="resetPasswordModal" style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.8); z-index: 9999; align-items: center; justify-content: center; backdrop-filter: blur(8px);">
    <div style="background: #0d1322; border: 1px solid rgba(0, 242, 254, 0.3); border-radius: var(--radius-lg); max-width: 420px; width: 90%; padding: 26px; box-shadow: 0 20px 50px rgba(0,0,0,0.8), 0 0 25px rgba(0,242,254,0.15);">
