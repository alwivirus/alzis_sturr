...
<div style="background: var(--bg-card); border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 24px; max-width: 1000px;">
    ...
    <form action="{{ route('admin.accounts.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group" style="margin-bottom: 20px; background: rgba(255,255,255,0.02); border: 1px solid var(--border); border-radius: 10px; padding: 14px 16px;">
            ...
            <span class="form-helper" style="font-size: 0.72rem; color: var(--text-dim); margin-top: 4px;">Isi jika postingan ini milik mitra/penjual tertentu. Biarkan kosong jika produk toko sendiri.</span>
        </div>
